...
return [
    ...
    'confirmed' => 'فیلدهای :attribute با هم تطابق ندارند.',
    ...
    'email' => 'آدرس ایمیل معتبر نیست لطفا از یک آدرس ایمیل معتبر استفاده کنید.',
    ...
    'custom' => [
        ...
        'name' => [
            ...
            'min' =>  'فیلد نام بایستی حداقل :min کاراکتر باشد'
        ],
        'username' => [
            'required' => 'فیلد نام کاربری الزامی است',
            'min' =>  'فیلد نام کاربری بایستی حداقل :min کاراکتر باشد',
            'unique' => 'نام کاربری وارد شده قبلا ثبت شده است. لطفا نام دیگری را امتحان کنید.'
        ],
        'phone' => [
        ...
        'password' => [
            ...
            'min' => 'رمز عبور بایستی حداقل ۶ کاراکتر باشد.',
            'confirmed' => 'پسوردهای وارد شده یکسان نیست'
        ],
        'negotiable' => [
            'boolean' => 'مقدار این فیلد بایستی به صورت دوگزینه‌ای صحیح-غلط باشد.',
        ],
        'attachment' => [
            'mimes' => 'فایل ضمیمه شده باید یکی از انواع :values باشد.',
            'image' => 'فایل ضمیمه شده باید حتما عکس باشد.',
            'max' => 'فایل ضمیمه شده نباید بیشتر از :max کیلوبایت باشد.'
        ],
        'thumbnail' => [
            'max' => 'اندازه عکس نباید بیشتر از :max کیلوبایت باشد.'
        ],
    ],
