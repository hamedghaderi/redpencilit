        ...
        function () {
            ...
            */
            ...
            Route::group(['prefix' => 'orders/{order}'], function () {
                ...
                Route::get('/details/{detail}/attachment', 'OrderAttachmentsController@show')
            ...
            */
            Route::group(['prefix' => 'admin'], function () {
                ...
                Route::get('pages/about', 'AdminPagesController@about')->name('admin.pages.about')->middleware('admin');
